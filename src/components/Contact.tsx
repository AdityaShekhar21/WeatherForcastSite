        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="p-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full group-hover:scale-110 transition-transform duration-200">
                    {info.icon}
                  </div>
                  <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-sm">
                ...
                please don't hesitate to call directly.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1 flex items-center justify-center space-x-2"
              >
                <Send size={20} />
